package it.ohalee.basementlib.common.persistence.sql.queries.data;
...
import it.ohalee.basementlib.api.persistence.sql.queries.builders.data.QueryBuilderReplace;
...
public class QueryReplace extends SqlQuery implements QueryBuilderReplace {
    ...
    public QueryReplace(AbstractSqlHolder holder, String database) {
